...
def home():
    ...
    st.image("C:/Users/lenovo/Documents/Documents/personal/Azubi Africa/Git Assignment/LP4 Repo Annette/Customer-churn-prediction.webp", use_column_width=True, caption="Predicting customer churn to retain valuable customers.")
